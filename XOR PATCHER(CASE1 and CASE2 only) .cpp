//THIS IS AN APPLICATION THAT CAN PATCH XOR KEYS TO DIFFERENT AREAS
//Block size is to be set manually before running the program
//Once completed it should have 6 combinations of DA SA ECC
